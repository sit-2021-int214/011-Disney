...
คำอธิบาย
```{R}
ใช้คำสั่ง Mode เพิ่ม parameter 'na.rm' พร้อมกำหนดเท่ากับ TRUE
ในหาความถี่ของคนที่ไม่เคยสูบบุหรี่เลย เพื่อให้สามารถหาความถี่ได้โดยที่ไม่ติดค่า NA
และใช้คำสั่ง summary แสดงข้อมูลสรุป Smoke จาก Data set: survey
```
